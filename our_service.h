...
//#define BLE_UUID_OUR_SERVICE_UUID                0x10C5 // Just a random, but recognizable value
 ...
 */
void our_time_characteristic_update(ble_os_t *p_our_service, int32_t *temperature_value);
